          ...
          <div className="relative lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            <div className="relative z-10">
              ...
              <p className="mt-8 text-lg text-gray-700">
                Always seeking the best service, <strong>WSB Cargo & Logistics</strong> establishes partnerships with all major shipping companies. We operate on every continent, offering agile service that meets our rigorous system of excellence and quality.
              </p>
